<footer class="footer" style="background: linear-gradient(to right, #aafaa5, #8df593);">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <h3>our email</h3>
         <a href="mailto:tasfiatahsinannita@gmail.com">tasfiatahsinannita@gmail.com</a>
      </div>
      ...
      <div class="box">
         ...
         <h3>our address</h3>
         <a href="#">Dhaka, Bangladesh - Aftabnagar Road</a>
   ...
   <div class="credit">&copy; <?= date('Y'); ?> <span>The EWU SLICE</span></div>
